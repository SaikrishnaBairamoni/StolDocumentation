\hypertarget{md_signal_opt_service_readme_autotoc_md93}{}\doxysubsection{Introduction}\label{md_signal_opt_service_readme_autotoc_md93}
...
\end{longtabu}
\hypertarget{md_signal_opt_service_readme_autotoc_md96}{}\doxysubsection{Additional parameters}\label{md_signal_opt_service_readme_autotoc_md96}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_signal_opt_service_readme_autotoc_md97}{}\doxysection{Implementation}\label{md_signal_opt_service_readme_autotoc_md97}
